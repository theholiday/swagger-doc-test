...
[![Build Status](https://travis-ci.org/theholiday/swagger-doc-test.svg?branch=master)](https://travis-ci.org/theholiday/swagger-doc-test)
...
6. If you did everything correct, https://theholiday.github.io/swagger-doc-test/ will lead to your new docs
...
- Documentation(ReDoc): https://theholiday.github.io/swagger-doc-test/
- SwaggerUI: https://theholiday.github.io/swagger-doc-test/swagger-ui/
- Look full spec:
    + JSON https://theholiday.github.io/swagger-doc-test/swagger.json
    + YAML https://theholiday.github.io/swagger-doc-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://theholiday.github.io/swagger-doc-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://theholiday.github.io/swagger-doc-test/ with url from the message: `Server started <url>`
